...
const validateConfig = () => {
  ...
  if (!FORGEROCK_ISSUER) missingEnvVars.push('FORGEROCK_ISSUER');
  if (!FORGEROCK_CLIENT_ID) missingEnvVars.push('FORGEROCK_CLIENT_ID');
  if (!FORGEROCK_CLIENT_SECRET) missingEnvVars.push('FORGEROCK_CLIENT_SECRET');
