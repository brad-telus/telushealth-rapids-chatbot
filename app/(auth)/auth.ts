...
if (!process.env.FORGEROCK_ISSUER) missingEnvVars.push('FORGEROCK_ISSUER');
if (!process.env.FORGEROCK_CLIENT_ID) missingEnvVars.push('FORGEROCK_CLIENT_ID');
if (!process.env.FORGEROCK_CLIENT_SECRET) missingEnvVars.push('FORGEROCK_CLIENT_SECRET');
